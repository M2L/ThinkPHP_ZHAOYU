...
require './app/Lib/app_init.php';
	    ...
	    $img_result = save_image_upload($_FILES,"image_file","attachment/images/".$dir,$whs=array('thumb'=>array(50,50,1,0)),1,1);
	    else
		$img_result = save_image_upload($_FILES,"image_file","attachment/images/".$dir,$whs=array('thumb'=>array(50,50,1,0)),0,1);	

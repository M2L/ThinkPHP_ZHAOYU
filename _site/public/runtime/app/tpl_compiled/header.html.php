...
?>
					<li <?php if ($this->_var['nav_item']['current'] == 1): ?>class="current"<?php endif; ?>>
						<span >
						<a href="<?php echo $this->_var['nav_item']['url']; ?>"  target="<?php if ($this->_var['nav_item']['blank'] == 1): ?>_blank<?php endif; ?>" title="<?php echo $this->_var['nav_item']['name']; ?>" class="font_gray <?php echo $this->_var['nav_item']['color']; ?>"><?php echo $this->_var['nav_item']['name']; ?></a>	
						</span>		
					</li>

...
require './app/Lib/app_init.php';
	    ...
	    $img_result = save_image_upload($_FILES,"imgFile","attachment/images/".$dir,$whs=array('thumb'=>array(100,100,1,0)),1,1);
	    else
		$img_result = save_image_upload($_FILES,"imgFile","attachment/images/".$dir,$whs=array('thumb'=>array(100,100,1,0)),0,1);	
